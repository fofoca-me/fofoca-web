        ...
        >
          {data.map((notification) => {
            ...
            return (
              ...
              >
                <a
                  className='hover-animation accent-tab relative flex flex-col gap-0.5 p-4 duration-200 bg-white hover:shadow-md dark:bg-zinc-900 rounded-md border dark:border-main-background'
                ...
                >
                  ...
                  {!notification.isChecked && (
                    <div className='absolute right-2 top-2 w-3 h-3 rounded-full bg-main-accent'></div>
                  )}
                </a>
              </Link>
            );
